                ...
                <List containerStyle={{ marginBottom: 0 }}>
                    {
                        list.map((l, i) => (
                            <ListItem
                                ...
                                onPress={() => {
                                    this.props.navigation.navigate('UserReview')
                                }}
                            />
                        ))
                    }
...
const UserRouteStack = {
    User: {
        screen: (props) => {
            const { screenProps, ...otherProps } = props;
            return <User {...props.screenProps} {...otherProps} />
        },
...
const UserNav = StackNavigator(UserRouteStack);
export default (props) => {
    const { screenProps, rootNavigator, ...otherProps } = props;

    return <UserNav screenProps={{ rootNavigator, ...screenProps, ...otherProps }} />
};
